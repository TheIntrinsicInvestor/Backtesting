...
<header class="hero">
  <div class="hero-inner">
    ...
    <div class="hero-meta">
      ...
      <div class="hero-meta-item"><strong>Data</strong>CRSP, Fama-French, OptionMetrics, FRED</div>
...
<div class="kpi-strip">
  ...
  <div class="kpi-cell">
    ...
    <div class="kpi-sub">n={n_cut} avg: 2001, 2007, 2024</div>
  </div>
  <div class="kpi-cell">
...
<section class="section" id="s2" style="background:var(--bg2)">
  <div class="container">
    ...
    <p>
      ...
      regime spell, VIX above 80). All three are shown individually throughout this report, never averaged
...
<section class="section" id="s4" style="background:var(--bg2)">
  <div class="container">
    ...
    <p>
      ...
      first-hikes, it is roughly flat at {lvl_delta(fh_t90)}. The two isolated insurance cuts and the
...
<section class="section" id="s5">
  <div class="container">
    ...
    <p>
      In the {n_cut}-turn reactive-cut window, <strong>{IND_NAMES[worst_cut_sector]}</strong> is the
      ...
      three episodes than a structural pattern. Around hikes, sector dispersion is far more muted:
    ...
    <div class="chart-box">
      ...
      <div class="chart-legend">
        ...
        <span><span class="legend-dot" style="background:#dc2626"></span>First cut, reactive (n={n_cut})</span>
      </div>
    </div>
    <div class="callout amber">
...
<section class="section" id="s6" style="background:var(--bg2)">
  <div class="container">
    ...
    <p>
      ...
      pattern in the whole report shows up here. In the {n_cut}-turn reactive-cut transition window, the
...
<section class="section" id="s7">
  <div class="container">
    ...
    <p>
      ...
      classic post-recession-onset steepening. The 10-year level itself falls {dgs10_fh_90:+.2f} points
      around hikes and {dgs10_fc_90:+.2f} points around reactive cuts.
    </p>
    <div class="chart-box">
  ...
  <div class="container">
    ...
    <table class="method-table">
      ...
      <tbody>
        ...
        <tr><td>Implied vol</td><td>OptionMetrics vsurfd, SPX (secid 108105), 30-day ATM (delta 50).
          Available from 1996 onward. The 1994 turn, and partially the 1999 turn, lacks this overlay.</td></tr>
