  ...
  <div class="container">
    ...
    <table class="method-table">
      ...
      <tbody>
        ...
        <tr><td>Out of scope</td><td>Politicians' own trades evaluated against pre-trade prices (would require pre-trade-date price benchmarks); IPO-related disclosures and ESOP grants; options trades; non-US equities; events from 2025 onward (CRSP cutoff)</td></tr>
      </tbody>
    </table>

    <div class="callout red">
      <strong>Verdict on NANC and KRUZ.</strong> Both wrappers are paying 0.75% annually to deliver beta-tilted exposure to mega-cap equities, dressed in a disclosure-tracking narrative that the underlying data does not support. KRUZ has underperformed SPY by approximately 20 points cumulatively. NANC has narrowly outperformed in absolute terms but trails on risk-adjusted basis. Neither product justifies the fee, and neither captures any informational edge that survives the disclosure lag.
    </div>
    <div class="callout amber">
      <strong>Sample-window limitation.</strong> The CRSP data ends December 2024, restricting the usable backtest window to 18 months and the primary sample to n={kpi_n} events. The qualitative direction of every result (null buy signal, weak directional sell signal, no committee-jurisdiction edge, KRUZ underperformance) is consistent with the academic literature on longer samples. A definitive replication on 5+ years of post-cutoff data would not be expected to change the verdict, but it would tighten the confidence intervals.
    </div>
    <div class="callout blue">
