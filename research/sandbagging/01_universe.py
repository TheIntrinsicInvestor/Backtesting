"""
01_universe.py  —  S&P 500 point-in-time constituents, 2014-2025
...
START = "2014-10-01"   # T-90 buffer before first 2015 event
END   = "2025-12-31"
...
print("Pulling name data from stocknames_v2...")
names = db.raw_sql(f"""
