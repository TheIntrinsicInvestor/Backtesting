...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0}}
    ...
    p{{color:var(--muted);line-height:1.75;margin-bottom:1rem;text-align:justify;hyphens:none;word-break:normal;overflow-wrap:normal}}    p:last-child{{margin-bottom:0}}
