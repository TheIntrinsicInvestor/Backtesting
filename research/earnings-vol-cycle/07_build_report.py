...
<section class="section" id="s6" style="background:var(--bg2)">
  <div class="container">
    ...
    than at T-1. For a short straddle, time decay works in your favour regardless of entry. The risk of
    entering earlier is vega exposure: IV continues running up between entry and the event, and as a short
    seller, rising IV works against you. Earlier entries also carry more pre-announcement delta risk if the
    stock drifts before the number drops.</p>
